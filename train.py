...
train_X,valid_X,train_label,valid_label = train_test_split(train_X, train_Y_one_hot, test_size=0.1, random_state=7)
...
animals_model.add(Dense(256, activation = 'relu'))
animals_model.add(Dense(256, activation = 'linear'))
animals_model.add(Dense(256, activation = 'relu'))
animals_model.add(Dense(256, activation = 'relu'))
animals_model.add(Dense(256, activation = 'relu'))
animals_model.add(Dense(256, activation = 'relu'))
